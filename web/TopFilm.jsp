...
<%
     ...
     List<Trailer> list20 = (List<Trailer>) session.getAttribute("list20");
...
<head>
    ...
    <link href="hThanhĐTttps://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
        rel="stylesheet">
    <link rel="stylesheet" href="topfilm.css">
        ...
        <div class="head-site">
            <div class="head-site-first">
                <div class="head-site-first-title">
                    <p>Top Film</p>
                    <p>Director · Cast · Writer</p>
                </div>
                <div class="head-site-first-rating">
                    <div class="links">
                        <a href="#">Oscar ·</a>
                        <a href="#">Golden Globe ·</a>
                        <a href="#">Trivia ·</a>
            ...
            <div class="head-site-second">
                ...
                <div class="img1" style="width: 45%;">
                    <img src="https://scontent.fdad1-3.fna.fbcdn.net/v/t39.30808-6/421466141_768468955308363_8016726203236945110_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=127cfc&_nc_ohc=JLNJDZgQlCAQ7kNvgE8O1jU&_nc_ht=scontent.fdad1-3.fna&oh=00_AYB62yGUrdIj9WJ9gW07Ja0UBvagLtH49VpZtRa-wtJkSQ&oe=669934DD " alt="">
                </div>
                <div class="img2"
                    style="width: 55%; overflow: hidden; border-radius: 20px; display: flex; justify-content: center; align-items: center;">
                    <iframe width="100%" height="400" src="https://www.youtube.com/embed/otMN_i7d2P8?autoplay=1&mute=1"
        ...
        <div class="middle-site">
            <div class="top">
                <div class="header-news">
                    ...
                    <% 
                                        for(Trailer t: list20){                                                                               
                                      %>
                <div class="movie-card" style="margin-top: 20px;">
                    <div class="movie-poster" style="width: 20%;">
                          <img src = <%
                                                     out.println(t.getImgUrl());
                                                    %>
                            alt="">
                    </div>
                    <div class="movie-details" style="width: 50%;">
                        <h2 class="movie-title"><%
                                          out.println(t.getMovieID().getTitle());
                                                    %></h2>
                        <div class="movie-info">
                            <span><%
                                          out.println(t.getMovieID().getRealaseTime());
                                                    %></span>
                            <span><%
                                          out.println(t.getMovieID().getMovieLength());
                                                    %></span>
                            <span>15</span>
                        </div>
                        <div class="movie-rating">
                            <span class="rating-star"><%
                                          out.println(t.getMovieID().getRating());
                                                    %></span>
                            <span class="rating-count">(2.9M)</span>
                            <span class="rate-link">★ Rate</span>
                        </div>
                    </div>
                    
                    <div class="movie-more-info"style="width: 20%;">
...
<!--                <div class="movie-card">
                    <div class="movie-poster" style="width: 20%;">
                        <img src="https://m.media-amazon.com/images/M/MV5BNDE3ODcxYzMtY2YzZC00NmNlLWJiNDMtZDViZWM2MzIxZDYwXkEyXkFqcGdeQXVyNjAwNDUxODI@._V1_.jpg" alt="The Shawshank Redemption"style="border-radius: 0 10px 10px 10px;">
                    </div>
                    <div class="movie-details" style="width: 50%;">
                        <h2 class="movie-title">1. The Shawshank Redemption</h2>
                        <div class="movie-info">
                            <span>1994</span>
                            <span>2h 22m</span>
                            <span>15</span>
                        ...
                        <div class="movie-rating">
                            <span class="rating-star">★ 9.3</span>
                            <span class="rating-count">(2.9M)</span>
                            <span class="rate-link">★ Rate</span>
                        </div>
                    </div>

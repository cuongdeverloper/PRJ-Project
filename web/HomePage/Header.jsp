        ...
        <div class="HomePage-header">
            <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-container">
                <div class="container-fluid header-container">
                    <a class="navbar-brand title-header while-font" href="./home">King Movie</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item search-form-header">
                                <form action="http://localhost:8080/Group_Project/Search" method="GET" class="search-form" id="search-form">
                                    <div class="dropdown">
                            ...
                            <li class="nav-item nav-item-watchlist">
                                <a class="btn btn-watchlist" href="WatchList">
                            ...
                            <li class="nav-item nav-item-profile dropdown">
                                <a class="nav-link while-font a-profile-header dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                   data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <% } else {%>
                                    <span class="span-profile">User <%= user.getUserName()%></span>
                                    <% } %>
                                </a>
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <li><a class="dropdown-item" href="Login">Login</a></li>
                                            <% } else { %>
                                        <li><a class="dropdown-item" href="Profile">Setting profile</a></li>
                                ...
                                <div class="mb-auto p-2 bd-highlight row" style="width: 100%; height: auto;">
                                    <div class="col-md-4">
                                        ...
                                        <div class="list-group group-title">
                                            ...
                                            <a href="./topMovie" class="list-group-item list-group-item-action">Top 250 Movies</a>
                                            <a href="./TopActor.jsp" class="list-group-item list-group-item-action">Most Popular Actors</a>

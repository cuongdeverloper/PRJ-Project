                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="img-slide" src=
                                        <% 
                                            trailerList.get(0).getImgUrl();
                                            out.println(trailerList.get(0).getImgUrl());
                                        %>
                                      alt="First slide">
                                ...
                                <div class="slide-model-trailer img-child-slide"> 
                                    <a href="google.com">
                                        ...
                                        <div class="child-action">
                                            ...
                                            <div class="child-action-description">
                                                <span class="while-font title-film">
                                                    <%
                                                        out.println(t.getMovieID().getTitle());
                                                    %>
                                                </span> <br>
                                                <span class="while-font trailer-film">
                                                    <%
                                                        out.println(t.getMovieID().getPlot());
                                                    %>
                                                </span><br>
                                                <a class="child-action-reaction while-font" href="#">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">

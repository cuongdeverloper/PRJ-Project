...
<head>
    ...
    <title>KingMovie - Upload User Information</title>
...
<body class="bg-gray-100">
    <div class="flex">
        ...
        <div class="w-4/5 p-10 bg-white">
            <h2 class="text-2xl font-bold mb-8">Add User Information</h2>
            <form action="./adminController?action=addUsers" method="POST" class="space-y-6 max-w-md">
                <div>
                    <label for="fullName" class="block text-sm font-medium text-gray-700">User Name</label>
                    <input type="text" id="fullName" name="fullName" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="priority" name="priority" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                <div>

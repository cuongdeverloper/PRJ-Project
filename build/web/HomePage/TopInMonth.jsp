            ...
            <div class="owl-carousel owl-theme bbb_viewed_slider">
                ...
                <div class="card">
                    <div class="hoverImg">
                        ...
                        <a href=<%= t.getVideoUrl()%> target="blank" class="a-img">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><%= t.getMovieID().getTitle()%></p>
                        <button class="btn btn-watchlist">+ Watchlist</button>
                        <div class="card-footer">
                            <button class="btn" type="submit" onclick="location.href='<%= t.getVideoUrl() %>'">
